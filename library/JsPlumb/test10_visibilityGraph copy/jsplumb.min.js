(function () {
   ...
   function d(a, b, d, e) {
      ...
      if (m >= 0)
         (f =
            c(l + Math.sqrt(m)) * Math.pow(Math.abs(l + Math.sqrt(m)), 1 / 3)),
            (g =
               c(l - Math.sqrt(m)) *
               Math.pow(Math.abs(l - Math.sqrt(m)), 1 / 3)),
            (n[0] = -h / 3 + (f + g)),
            (n[1] = -h / 3 - (f + g) / 2),
            (n[2] = -h / 3 - (f + g) / 2),
         ...
         (n[0] = 2 * Math.sqrt(-k) * Math.cos(o / 3) - h / 3),
            (n[1] =
               2 * Math.sqrt(-k) * Math.cos((o + 2 * Math.PI) / 3) - h / 3),
            (n[2] =
               2 * Math.sqrt(-k) * Math.cos((o + 4 * Math.PI) / 3) - h / 3);
      }
   ...
   function () {
      ...
      var d = this,
         ...
         l = function (a, b, c) {
            if (
               (a.__ta && a.__ta[b] && delete a.__ta[b][c.__tauid], c.__taExtra)
            ) {
         ...
         H = function (a, b, c) {
            null != c &&
               I(a, function () {
                  ...
                  c.__taTouchProxy &&
                     H(a, c.__taTouchProxy[1], c.__taTouchProxy[0]);
               });
         },
         I = function (a, b) {
            if (null != a) {
      ...
      var a = this,
         ...
         F = function (a, b, c, d) {
                        ...
                        if (d) {
                           ...
                           G && z(a),
                              ...
                              J &&
                                 J.parentNode &&
                                 (F = [
                                    J.parentNode.scrollLeft,
                                    J.parentNode.scrollTop,
                                 ]),
                              this.params.bind(
                                 document,
                                 'mousemove',
            ...
            b.events.start && ea.start.push(b.events.start),
               b.events.beforeStart &&
                  ea.beforeStart.push(b.events.beforeStart),
         ...
         (this.addToPosse = function (a, b) {
            ...
            (this.removeFromPosse = function (a, b) {
               if (arguments.length < 2)
                  throw new TypeError(
                     'No posse id provided for remove operation'
                  );
      ...
      function v(b, c, d) {
         ...
         var h = function (a, b) {
               return function () {
                  for (e = 0; e < c.length; e++)
                     c[e].prototype[a] &&
                        c[e].prototype[a].apply(this, arguments);
                        ...
                        if (
                           ...
                           for (; !f && d > e && g !== !1; ) {
                              if (this.eventsToDieOn[a])
                                 ...
                                 try {
                                    g = this._listeners[a][e].apply(this, [
                                       b,
                                       c,
                                    ]);
                                 } catch (h) {
                                    B(
                                       'jsPlumb: fire failed for event ' +
                                          a +
                                          ' : ' +
                                          h
                                    );
      ...
      (b.jsPlumbListManager = c),
         (c.prototype = {
            addList: function (b, c) {
               ...
               var f = [this.instance.getInstanceIndex(), this.count++].join(
                  '_'
               );
            ...
            _maybeUpdateParentList: function (a) {
               for (
                  ...
                  if (
                     null != b._jsPlumbList &&
                     null != this.lists[b._jsPlumbList]
                  )
      ...
      var d = function (a, b, c, d) {
         ...
         function g(b) {
            for (
               ...
               if (a.hasClass(c, 'jtk-managed'))
                  return void a.recalculateOffsets(c);
               c = c.parentNode;
            }
         }
         b._jsPlumbList = d;
         ...
         a.setAttribute(b, 'jtk-scrollable-list', 'true'),
            ...
            (this.destroy = function () {
               ...
               for (
                  var c = a.getSelector(b, '.jtk-managed'),
                     d = a.getId(b),
                     e = 0;
                  e < c.length;
                  e++
   ...
   function () {
         ...
         addType: function (a, b, c) {
            ...
            if (null != d) {
               for (var g = 0, i = d.length; i > g; g++)
                  this.hasType(d[g]) ||
                     (this._jsPlumb.types.push(d[g]), (e = !0));
               e && h(this, b, c);
            }
         },
         ...
         m = (a.jsPlumbInstance = function (c) {
            ...
            (this.getInstanceIndex = function () {
               ...
               (this.setZoom = function (a, b) {
                  return (
                     (j = a), e.fire('zoom', j), b && e.repaintEverything(), !0
                  );
               }),
               (this.getZoom = function () {
                  return j;
            ...
            var q = null,
               ...
               K = function (a, c) {
                  ...
                  if (
                     ...
                     for (
                        var f = 0,
                           g = d.sourceEndpoint.connectorOverlays.length;
                        g > f;
                        f++
                     )
               ...
               L = function (a) {
                  var b =
                     e.Defaults.ConnectionType || e.getDefaultConnectionType();
                  (a._jsPlumb = e),
                     (a.newConnection = L),
                     (a.newEndpoint = N),
                     (a.endpointsByUUID = u),
               ...
               N = function (a, b) {
                  ...
                  return (
                     ...
                     n.headless ||
                        e.getDragManager().endpointAdded(d.source, b),
                     f
                  );
               },
               O = function (a, b, c) {
                  ...
                  if (d && d.length)
                     for (var e = 0, f = d.length; f > e; e++) {
                        for (
                           var g = 0, h = d[e].connections.length;
                           h > g;
                           g++
                        ) {
            ...
            (this.setConnectionBeingDragged = function (a) {
               ...
               (this.endpointDropForbiddenClass =
               ...
               (this.sourceElementDraggingClass =
                  'jtk-source-element-dragging'),
               (this.targetElementDraggingClass =
                  'jtk-target-element-dragging'),
               ...
               (this.addEndpoints = function (a, c, d) {
                  for (var f = [], g = 0, h = c.length; h > g; g++) {
                     ...
                     b.isArray(i)
                        ? Array.prototype.push.apply(f, i)
                        : f.push(i);
                  }
                  return f;
               }),
            ...
            var T = [
               ...
               U = function (a, b, c, d) {
                  ...
                  if (b.constructor === n.Endpoint)
                     ...
                     ((f = S(b)), (g = this[h.epDefs][f]), f === a[h.elId])
                  )
                     e = null;
                  else if (g)
                     for (var l in g) {
            ...
            var V = function (a, b, c) {
                  var d =
                        e.Defaults.ConnectionType ||
                        e.getDefaultConnectionType(),
                     f = a.constructor === d,
                     g = f
                        ? {
                             connection: a,
                  ...
                  var j = new i(d),
                     k = d._jsPlumb.EndpointDropHandler({
                        ...
                        isFull: function () {
                           ...
                           return (
                              c.def.maxConnections > 0 &&
                              a >= c.def.maxConnections
                           );
                        },
                        element: c.el,
                        elementId: c.id,
                           ...
                           var u = function (c) {
                              if (3 !== c.which && 2 !== c.button) {
                                 ...
                                 if (k.enabled) {
                                    ...
                                    var q = a.jsPlumb.getPositionOnElement(
                                          c,
                                          i,
                                          j
                                       ),
                                    ...
                                    e.trigger(s.canvas, 'mousedown', c, v),
                                       b.consume(c);
                                 }
                              }
                           }.bind(this);
                     ...
                     for (var g in f)
                        if (null == b || b === g) {
                           ...
                           h && e.off(d.el, 'mousedown', h),
                              c ||
                                 delete this.sourceEndpointDefinitions[d.id][g];
                        }
                  return this;
               }),
            ...
            (this.getScope = function (a, b) {
               ...
               (this.setSourceScope = function (a, b, c) {
                  ra(a, b, 'sourceEndpointDefinitions', c),
                     this.setDragScope(a, b);
               }),
               (this.setTargetScope = function (a, b, c) {
                  ra(a, b, 'targetEndpointDefinitions', c),
            ...
            (this.toggleSourceEnabled = function (a, b) {
               ...
               (this.toggleTargetEnabled = function (a, b) {
                  return (
                     sa('target', a, null, !0, b), this.isTargetEnabled(a, b)
                  );
               }),
            ...
            (this.repaint = function (a, b, c) {
               ...
               (this.repaintEverything = function () {
                  var a,
                     b = jsPlumbUtil.uuid();
                  for (a in t)
                     e.updateOffset({ elId: a, recalc: !0, timestamp: b });
                  ...
                  var c = e.getDragManager(),
                     d = function (a) {
                        c && c.elementRemoved(a.id),
                           ...
                           delete w[a.id],
                           a.el &&
                              (e.removeElement(a.el), (a.el._jsPlumb = null));
                     },
                     f = 1;
                  f < b.length;
                  f++
      ...
      b.extend(a.jsPlumbInstance, b.EventGenerator, {
         ...
         registerConnectionType: function (b, c) {
            if (
               ((this._connectionTypes[b] = a.jsPlumb.extend({}, c)),
               c.overlays)
            ) {
         ...
         registerEndpointType: function (b, c) {
            if (
               ((this._endpointTypes[b] = a.jsPlumb.extend({}, c)), c.overlays)
            ) {
               for (var d = {}, e = 0; e < c.overlays.length; e++) {
                  var f = this.convertToFullOverlaySpec(c.overlays[e]);
                  d[f[1].id] = f;
      ...
      var a = this,
         ...
         f = function (a, d) {
            ...
            if (c.isArray(d)) {
               var f = d[0],
                  g = b.extend(
                     { component: a, _jsPlumb: a._jsPlumb.instance },
                     d[1]
                  );
               3 === d.length && b.extend(g, d[2]),
                  (e = new b.Overlays[a._jsPlumb.instance.getRenderMode()][f](
                     g
                  ));
            } else
               e =
            ...
            b.label &&
               (this.getDefaultType().overlays[d] = [
                  'Label',
                  {
                     label: b.label,
                     location:
                        b.labelLocation || this.defaultLabelLocation || 0.5,
                     labelStyle:
                        b.labelStyle ||
                        this._jsPlumb.instance.Defaults.LabelStyle,
                     id: d,
                  },
               ]),
            (this.setListenerComponent = function (a) {
   ...
   function () {
      ...
      (b.Endpoint = function (a) {
         ...
         (this.prepareAnchor = function (a) {
            ...
            return (
               b.bind(
                  'anchorChanged',
                  function (a) {
                     this.fire('anchorChanged', { endpoint: this, anchor: a }),
                        n();
                  }.bind(this)
               ),
               b
         ...
         this.bind('mouseover', function () {
            ...
            a.onMaxConnections &&
               this.bind('maxConnections', a.onMaxConnections),
            ...
            (this.detachFromConnection = function (a, b, c) {
               (b = null == b ? this.connections.indexOf(a) : b),
                  b >= 0 &&
                     ...
                     this[
                        (this.connections.length > 0 ? 'add' : 'remove') +
                           'Class'
                     ](i.endpointConnectedClass),
                     this[(this.isFull() ? 'add' : 'remove') + 'Class'](
                        i.endpointFullClass
               ...
               var g,
                  ...
                  y = function (c) {
                     ...
                     if (
                        ...
                        return (
                           i.stopDrag && i.stopDrag(this.canvas),
                           q.stopDrag(),
                           !1
                        );
                     ...
                     if (
                        null == this.dragProxy &&
                        null != this.connectionType
                     ) {
                        var v =
                           this._jsPlumb.instance.deriveEndpointAndAnchorSpec(
                              this.connectionType
                           );
                           ...
                           i.setDragScope(o[2], o[3]),
                              ...
                              !i.deleteConnection(m, { originalEvent: a })
                                 ? (m.setHover(!1),
                                   ...
                                   this._jsPlumb.floatingEndpoint.detachFromConnection(
                                      m
                                   ),
         ...
         var t = function (d, e, f, g) {
            if (b.isDropSupported(this.element)) {
               var h =
                  a.dropOptions ||
                  i.Defaults.DropOptions ||
                  b.Defaults.DropOptions;
                           ...
                           var e = i.getFloatingAnchorIndex(d),
                              f =
                                 ...
                                 (d.suspendedEndpoint &&
                                    ...
                                    this.referenceEndpoint.id ===
                                       d.suspendedEndpoint.id);
                           if (f) {
         ...
         c.extend(b.Endpoint, b.OverlayCapableJsPlumbUIComponent, {
               ...
               if (
                  ...
                  for (var d = 0; d < this.connections.length; d++)
                     if ((this.connections[d].setVisible(a), !c)) {
                        var e =
                           this === this.connections[d].endpoints[0] ? 1 : 0;
                        1 ===
                           this.connections[d].endpoints[e].connections
                              .length &&
                           this.connections[d].endpoints[e].setVisible(
                              a,
                              !0,
                              !0
                           );
            ...
            cleanup: function () {
               ...
               b.removeClass(this.element, a),
                  ...
                  (this.endpoint = null),
                  this._jsPlumb.instance.destroyDraggable(
                     this.canvas,
                     'internal'
                  ),
                  this._jsPlumb.instance.destroyDroppable(
                     this.canvas,
                     'internal'
                  );
            },
                        ...
                        if (
                           ...
                           var o = function (b) {
                                 i.endpoints[l].detachFromConnection(i),
                                    i.suspendedEndpoint &&
                                       i.suspendedEndpoint.detachFromConnection(
                                          i
                                       ),
                                    (i.endpoints[l] = k),
                                    k.addConnection(i);
                                    ...
                                    d.fireMoveEvent(
                                       {
                                          ...
                                          originalSourceId:
                                             0 === l ? h : i.sourceId,
                                          newSourceId:
                                             0 === l ? k.elementId : i.sourceId,
                                          originalTargetId:
                                             1 === l ? h : i.targetId,
                                          newTargetId:
                                             1 === l ? k.elementId : i.targetId,
                              ...
                              p = function () {
                                 i.suspendedEndpoint &&
                                    ...
                                    0 === l
                                       ? ((i.source =
                                            i.suspendedEndpoint.element),
                                         (i.sourceId =
                                            i.suspendedEndpoint.elementId))
                                       : ((i.target =
                                            i.suspendedEndpoint.element),
                                         (i.targetId =
                                            i.suspendedEndpoint.elementId)),
   ...
   function () {
         ...
         d = function (a, d, e, f, g) {
            if (
               ...
               if (null == b.Connectors[e]) {
                  ...
                  throw new TypeError(
                     "jsPlumb: unknown connector type '" + e + "'"
                  );
               }
      ...
      (b.Connection = function (a) {
         ...
         (this.getTypeDescriptor = function () {
            ...
            (this._jsPlumb.cost =
               a.cost || this.endpoints[0].getConnectionCost()),
            (this._jsPlumb.directed = a.directed),
            null == a.directed &&
               (this._jsPlumb.directed =
                  this.endpoints[0].areConnectionsDirected());
         ...
         c.extend(b.Connection, b.OverlayCapableJsPlumbUIComponent, {
            ...
            removeClass: function (a, b) {
               b &&
                  ...
                  this.suspendedEndpoint &&
                     this.suspendedEndpoint.removeClass(a)),
                  ...
                  if (null == b || b !== this._jsPlumb.lastPaintedAt) {
                     var h = this._jsPlumb.instance.updateOffset({ elId: e }).o,
                        ...
                        l = j.anchor.getCurrentLocation({
                           ...
                           element: j,
                           timestamp: b,
                           rotation: this._jsPlumb.instance.getRotation(
                              this.sourceId
                           ),
                        }),
                     ...
                     this.connector.resetBounds(),
                        this.connector.compute({
                           ...
                           'stroke-width':
                              this._jsPlumb.paintStyleInUse.strokeWidth,
                           sourceInfo: h,
                           targetInfo: i,
                        });
                     var n = {
                     ...
                     var q =
                           parseFloat(
                              this._jsPlumb.paintStyleInUse.strokeWidth || 1
                           ) / 2,
                        r = parseFloat(
                        ...
                        s = {
                           xmin: Math.min(
                              this.connector.bounds.minX - (q + r),
                              n.minX
                           ),
                           ymin: Math.min(
                              this.connector.bounds.minY - (q + r),
                              n.minY
                           ),
                           xmax: Math.max(
                              this.connector.bounds.maxX + (q + r),
                              n.maxX
                           ),
                           ymax: Math.max(
                              this.connector.bounds.maxY + (q + r),
                              n.maxY
                           ),
                        };
                     (this.connector.paintExtents = s),
                        this.connector.paint(
                           this._jsPlumb.paintStyleInUse,
                           null,
                           s
                        );
            ...
            prepareEndpoint: function (a, c, d, f, g, h, i, j, k) {
               ...
               if (f) (d.endpoints[g] = f), f.addConnection(d);
                  ...
                  h.endpointStyles || (h.endpointStyles = [null, null]),
                     h.endpointHoverStyles ||
                        (h.endpointHoverStyles = [null, null]);
                  var n =
                     h.endpointStyles[g] ||
                     h.endpointStyle ||
                  ...
                  (l = c({
                     ...
                     detachable:
                        h.detachable || a.Defaults.ConnectionsDetachable,
                  })),
                  ...
                  h = function (b, c, d, g, h, i, k) {
                     if (g.length > 0)
                        for (
                           ...
                           v && s(u.endpoints[0], r[t]),
                              w && s(u.endpoints[1], r[t]);
                        }
                  };
            ...
            (this.newConnection = function (a) {
               var d = a.sourceId,
                  ...
                  i = function (i, j, k, l, m) {
                     d === e &&
                        k.isContinuous &&
                        (a._jsPlumb.instance.removeElement(f[1].canvas),
                        (h = !1)),
                        b.addToList(g, l, [
                           m,
                           j,
                           k.constructor === c.DynamicAnchor,
                        ]);
                  };
               ...
               if (a !== d) {
                  ...
                  i > -1 &&
                     ...
                     e.endpoints[1].anchor.isContinuous &&
                        (e.source === e.target
                           ? e._jsPlumb.instance.removeElement(
                                e.endpoints[1].canvas
                             )
                           : null == e.endpoints[1].canvas.parentNode &&
                             e._jsPlumb.instance.appendElement(
                                e.endpoints[1].canvas
                             )),
               ...
               h = {
                  ...
                  Path: function (a) {
                     for (
                        ...
                        var g = Math.sqrt(
                           Math.pow(b[f][2] - b[f][0]) +
                              Math.pow(b[f][3] - b[f][1])
                        );
                        (d += g),
                           c.push([
                              b[f][0],
      ...
      (b.Segments = {
            ...
            (this.params = a),
               ...
               (this.boxIntersection = function (a, b, c, d) {
                  ...
                  return (
                     ...
                     e.push.apply(
                        e,
                        this.lineIntersection(a + c, b, a + c, b + d)
                     ),
                     e.push.apply(
                        e,
                        this.lineIntersection(a + c, b + d, a, b + d)
                     ),
         ...
         Straight: function (a) {
            ...
            this.findClosestPointOnPath = function (a, b) {
               ...
               return (
                  (k.d = d.lineLength([a, b], [k.x, k.y])), (k.l = r / c), k
               );
            };
               ...
               if (k !== l)
                  if (k === 1 / 0 && 0 === l)
                     ...
                     k === 1 / 0
                        ? ((q = a),
                          o(q, g, h) &&
                             ((r = l * a + m), o(r, b, f) && (n = [q, r])))
                        : 0 === k
                        ? ((r = b),
                          o(r, i, j) &&
                             ((q = (b - m) / l), o(q, a, c) && (n = [q, r])))
                        : ((q = (p - m) / (l - k)),
                          (r = l * q + m),
         ...
         Arc: function (a) {
            var c =
               ...
               e = function (a, b) {
                  ...
                  var e =
                        a.endAngle < a.startAngle ? a.endAngle + f : a.endAngle,
         ...
         Bezier: function (c) {
            ...
            var i = function (b, c, d) {
               return (
                  d &&
                     (c = a.jsBezier.locationAlongCurveFrom(
                        b,
                        c > 0 ? 0 : 1,
                        c
                     )),
      ...
      (b.Connectors.AbstractConnector = function (a) {
         ...
         (this.getPathData = function () {
            ...
            (this.findSegmentForPoint = function (a, b) {
               for (
                  var c = { d: 1 / 0, s: null, x: null, y: null, l: null },
                     d = 0;
                  d < f.length;
                  d++
               ) {
         ...
         return (
            (this.pointOnPath = function (a, b) {
               var c = s(a, b);
               return (
                  (c.segment && c.segment.pointOnPath(c.proportion, !1)) || [
                     0, 0,
                  ]
               );
            }),
            (this.gradientAtPoint = function (a, b) {
               var c = s(a, b);
               return (
                  (c.segment && c.segment.gradientAtPoint(c.proportion, !1)) ||
                  0
               );
            }),
            (this.pointAlongPathFrom = function (a, b, c) {
               ...
               return (
                  (d.segment &&
                     d.segment.pointAlongPathFrom(d.proportion, b, !1)) || [
                     0, 0,
                  ]
               );
            }),
            ...
            if (
               ...
               if (
                  ...
                  var e = this.labelStyle.borderStyle
                     ...
                     : 'black';
                  d.style.border =
                     this.labelStyle.borderWidth + 'px solid ' + e;
               }
   ...
   function () {
      ...
      var a = this,
         ...
         z = function (a) {
            ...
            function h(b) {
               for (
                  var c = b.getMembers().slice(), d = [], e = 0;
                  e < c.length;
                  e++
               )
                  Array.prototype.push.apply(
                     ...
                     if (a._jsPlumbGroup === t) {
                        if (
                           ...
                           try {
                              ...
                              jsPlumbUtil.log(
                                 'Could not remove element from Group ' + f
                              );
                           }
                        if ((q(a), !e)) {
                           var h = { group: t, el: a };
      ...
      (c.prototype.addGroup = function (a) {
         ...
         (c.prototype.getGroupFor = function (a) {
            if ((a = this.getElement(a))) {
               for (
                  var b = this.getContainer(), c = !1, d = null, e = null;
                  !c;
      ...
      var a = this,
         ...
         f = function (a) {
            ...
            var c,
               ...
               h = null == a.midpoint || isNaN(a.midpoint) ? 0.5 : a.midpoint,
                           ...
                           var h = a,
                              ...
                              k =
                                 h[
                                    'is' +
                                       c.toUpperCase() +
                                       'GreaterThanStubTimes2'
                                 ];
                           if (
                              b.sourceEndpoint.elementId ===
                              b.targetEndpoint.elementId
                           ) {
                              var l =
                                 e +
                                 (1 - b.sourceEndpoint.anchor[i]) *
                                    b.sourceInfo[j] +
                                 g.maxStub;
                              return {
                                 x: [
      ...
      (b.Connectors.AbstractBezierConnector = function (a) {
         ...
         return (
            (this._compute = function (a, b) {
               ...
               if (
                  d &&
                  b.sourceEndpoint.elementId === b.targetEndpoint.elementId
               ) {
                  h = !0;
                  var m = b.sourcePos[0],
                     n = b.sourcePos[1] - e,
   ...
   function () {
            ...
            d.renderer.paint = function (d, e, f) {
               ...
               if (
                  ...
                  var j = {
                        ...
                        'pointer-events':
                           a['pointer-events'] || 'visibleStroke',
                     },
                     k = null,
                     l = [c.x, c.y, c.w, c.h];
                  if (d.outlineStroke) {
      ...
      var B = function (a, c) {
         ...
         C = {
            ...
            setVisible: function (a) {
               null != this.path &&
                  (this.path.style.display = a ? 'block' : 'none');
            },
         };
   ...
   function () {
               ...
               g ||
                  ((g = new d({
                     ...
                     getConstrainingRectangle: function (a) {
                        return [
                           a.parentNode.scrollWidth,
                           a.parentNode.scrollHeight,
                        ];
                     },
               ...
               var b,
                  ...
                  d = function (c) {
                     ...
                     null != c[1] &&
                        ...
                        (a.e._drawResult = a.e._drawResult || {
                           c: [],
                           e: [],
                           a: [],
                        }),
      ...
      a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
         ...
         draggable: function (a, b) {
            ...
            return (
               (a =
                  c.isArray(a) || (null != a.length && !c.isString(a))
                     ? a
                     : [a]),
         ...
         destroyDraggable: function (a, b) {
            g(this, b).destroyDraggable(a),
               (a._jsPlumbDragOptions = null),
               (a._jsPlumbRelatedElement = null);
         },
         ...
         _initDraggableIfNecessary: function (a, b, d, e, f) {
            if (!jsPlumb.headless) {
               ...
               if (g && jsPlumb.isDragSupported(a, this)) {
                  ...
                  if (
                     ((k = jsPlumb.extend({}, k)),
                     jsPlumb.isAlreadyDraggable(a, this))
                  )
                     ...
                     (k.disabled = null == p ? !1 : !p),
                        ...
                        f &&
                           this.fire('elementDraggable', { el: a, options: k });
                  }
               }
            }
         },
         ...
         getDragScope: function (a) {
            return (
               (a._katavorioDrag && a._katavorioDrag.scopes.join(' ')) || ''
            );
         },
